...
- Moral-Benito, E. (2016). "Growth Empirics in Panel Data Under Model Uncertainty and Weak Exogeneity." *Journal of Applied Econometrics*.
...
- Hofmarcher, P., Crespo Cuaresma, J., Grün, B., Humer, S., and Moser, M. (2018). "Bivariate jointness measures in Bayesian Model Averaging: Solving the conundrum." *Journal of Macroeconomics*.
