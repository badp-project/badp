...
[![R-CMD-check](https://github.com/badp-project/bdsm/actions/workflows/R-CMD-check-main.yaml/badge.svg)](https://github.com/badp-project/bdsm/actions/workflows/R-CMD-check-main.yaml)
...
devtools::install_github("badp-project/bdsm")
```
...
[GitHub](https://github.com/badp-project/bdsm).
