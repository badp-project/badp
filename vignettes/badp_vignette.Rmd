...
The default option is `dilution_par = 0.5`, as recommended by @George+2010.
...
Before moving to the BMA statistics, it is instructive to examine the change in the `dilution_par` parameter.
...
Conversely, raising the `dilution_par` parameter increases the degree of dilution.
